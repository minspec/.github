...
MinSpec is early and intentionally conservative. Contributions are most useful when they strengthen the architecture, clarify the doctrine, reduce ambiguity, or validate the package-and-recipe model.
...
- imply MinSpec is official Symfony
...
- Does this keep MinSpec independent and unofficial?
